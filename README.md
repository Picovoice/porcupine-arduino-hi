# Porcupine SDK for Arduino boards - Hindi language
...
1. Compile and upload the `Porcupine_HI/GetUUID` sketch from the `File -> Examples` menu. Copy the UUID of the board printed at the beginning of the session to the serial monitor.
